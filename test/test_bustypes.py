...
from systemd_ctypes import Bus, BusMessage, BusType, Handle, bus, bustypes, run_async
...
@pytest.fixture
def message(user_bus):
    return user_bus.message_new_method_call('x.y', '/y', 'z.a', 'a')

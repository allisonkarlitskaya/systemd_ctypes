...
# ruff: noqa: RUF036
# None-first Union ordering is intentional: None is the success case, Errno is the exceptional one
...
class sd_bus_message(ReferenceType):
    ...
    def set_allow_interactive_authorization(self: 'sd_bus_message', b: bool) -> Union[None, Errno]:
        ...
...
class sd_bus(ReferenceType):
    ...
    def set_allow_interactive_authorization(self: 'sd_bus', b: bool) -> Union[None, Errno]:
        ...
